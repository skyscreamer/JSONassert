 ...
 * 
 * <p>
 * There are two modes, strict and non-strict. In most cases, you will probably want to set strict to <i>false</i>, since that will make the tests less brittle.
 * </p>
 * 
 * <p>
 * Strict tests require all of the elements requested to be returned, and only those elements (ie, the tests are non-extensible). Arrays of elements must be
 * returned in the same order as expected. For example, say I'm expecting:
 * </p>
 * 
 ...
 * 
 * <p>
 * <i>This library uses org.json. It has fewer dependencies than other JSON libraries (like net.sf.json), making JSONassert more portable.</i>
 * </p>
 * 
 * <p>
 ...
 * </p>
 * <ul>
 * <li>Unless the order is strict, checking does not handle mixed types in the JSONArray (e.g. <code>[1,2,{a:"b"}]</code> or
 * <code>[{pet:"cat"},{car:"Ford"}]</code>)</li>
 * <li>Unless the order is strict, checking cannot handle arrays of arrays (e.g. <code>[[1,2],[3,4]]</code>)</li>
 * </ul>
 * <p>
 * You do not have to worry about encountering a false positive or false negative in these two edge cases. <i>JSONassert</i> will identify the conditions and
 * throw a descriptive {@link IllegalArgumentException}. These cases will be fixed in future versions.
 * </p>
 * 
 */
